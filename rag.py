...
f = open(r"C:\Users\saispandhana\Videos\key_genai.txt")
key = f.read()

st.title(":rainbow[RAG System: An Effective Approach for Managing Project Risks]📃")
...
#Loading Document
loader = PyPDFLoader(r"C:\Users\saispandhana\Downloads\RAG_System_with_LangChain_Framework-main\RAG_System_with_LangChain_Framework-main\2404.07143.pdf")
